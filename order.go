...
type OrderService interface {
	GetOrderList(sid uint64, item GetOrderListRequest, tok string) (*GetOrderListResponse, error)
...
type GetOrderListRequest struct {
	TimeRangeField         string `url:"time_range_field"`
	TimeFrom               int64  `url:"time_from"`
	TimeTo                 int64  `url:"time_to"`
	PageSize               int    `url:"page_size"`
	Cursor                 string `url:"cursor"`
	OrderStatus            string `url:"order_status"`
	ResponseOptionalFields string `url:"response_optional_fields"`
}
...
type GetOrderListResponse struct {
	...
	Response GetOrderListResponseData `json:"response"`
}
...
func (s *OrderServiceOp) GetOrderList(sid uint64, item GetOrderListRequest, tok string) (*GetOrderListResponse, error) {
